        ...
        <div class="md-form">
            <form v-on:submit="login()">
                ...
                <div style="display: inline-flex; width: 100%">
                    <p style="text-align: center; margin-left: auto;">Don't have an account?&nbsp</p>
                    <router-link :to="{name: 'Signup'}" class="quickLink">Sign up</router-link>
                </div>
            </form>
        </div>
    </div>
...
<style scoped>
    ...
    .quickLink {
        margin-right: auto; color: #42b983 !important;
    }
